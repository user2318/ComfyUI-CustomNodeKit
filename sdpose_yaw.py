        ...
        return {
            "required": {
                ...
                "conf_threshold": ("FLOAT", {"default": 0.3, "min": 0.0, "max": 1.0, "step": 0.05,
                                              "tooltip": "关键点置信度阈值，提高可减少噪声但可能丢失有效数据"}),
                "enable_smoothing": ("BOOLEAN", {"default": True,
                                                  "tooltip": "平滑开关，开启时对角度做时序平滑（5帧滑动窗口），关闭时跟随原始关键点更灵敏"}),
            },
            "optional": {
